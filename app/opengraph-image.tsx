...
export const alt = "Exa Vantage";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

// Per the build standard: the OG image is the logo only, sized large to fill the
// frame, no text baked in. Here it is the official Exa wordmark on white, so the
// share card reads as Exa (the app name + tagline live in the share text).
export default function OpengraphImage() {
  return new ImageResponse(
    (
      ...
      >
        <svg width="620" height="223" viewBox="0 0 278 100" fill="none">
          <path
